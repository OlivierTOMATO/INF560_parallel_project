...
int main(int argc, char **argv)
{
    ...
    if (rank == 0)
    {
        printf("MPI ONLY: Divide the record file into average size (size == file size / the number of ranks) and Allocate it directly to all the ranks (including the rank 0)\n");
